...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/tg/Documents/GitHub/remix-blog/cloud-functions/upload-tiktok-video/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  config.dirname = path.join(process.cwd(), "cloud-functions/upload-tiktok-video/generated")
...
path.join(process.cwd(), "cloud-functions/upload-tiktok-video/generated/libquery_engine-darwin-arm64.dylib.node")
...
path.join(process.cwd(), "cloud-functions/upload-tiktok-video/generated/libquery_engine-debian-openssl-3.0.x.so.node")
