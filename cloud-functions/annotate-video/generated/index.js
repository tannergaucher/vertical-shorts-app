...
const config = {
  "generator": {
    "name": "cloudAnnotateVideo",
    "provider": {
      "fromEnvVar": null,
      "value": "prisma-client-js"
    },
    "output": {
      "value": "/Users/tg/Documents/vertical-shorts-app/cloud-functions/annotate-video/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  config.dirname = path.join(process.cwd(), "../cloud-functions/annotate-video/generated")
...
path.join(process.cwd(), "../cloud-functions/annotate-video/generated/libquery_engine-darwin-arm64.dylib.node")

path.join(__dirname, "libquery_engine-debian-openssl-1.1.x.so.node");
path.join(process.cwd(), "../cloud-functions/annotate-video/generated/libquery_engine-debian-openssl-1.1.x.so.node")

path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "../cloud-functions/annotate-video/generated/libquery_engine-debian-openssl-3.0.x.so.node")

path.join(__dirname, "libquery_engine-rhel-openssl-1.0.x.so.node");
path.join(process.cwd(), "../cloud-functions/annotate-video/generated/libquery_engine-rhel-openssl-1.0.x.so.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../cloud-functions/annotate-video/generated/schema.prisma")
