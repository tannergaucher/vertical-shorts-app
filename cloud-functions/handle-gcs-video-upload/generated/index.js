...
const config = {
  "generator": {
    "name": "handleGcsVideoUpload",
    "provider": {
      "fromEnvVar": null,
      "value": "prisma-client-js"
    },
    "output": {
      "value": "/Users/tg/Documents/GitHub/remix-blog/cloud-functions/handle-gcs-video-upload/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  config.dirname = path.join(process.cwd(), "cloud-functions/handle-gcs-video-upload/generated")
...
path.join(process.cwd(), "cloud-functions/handle-gcs-video-upload/generated/libquery_engine-darwin-arm64.dylib.node")
...
path.join(process.cwd(), "cloud-functions/handle-gcs-video-upload/generated/libquery_engine-debian-openssl-3.0.x.so.node")
